...
\begin{itemize}
  ...
  \item \textbf{Prosty algorytm genetyczny} -- wersja algorytmu, w której odrzuca się rozwiązania nie spełniające dane ograniczenia problemu.

  \item \textbf{Algorytm genetyczny zmodyfikowany} -- wersja algorytmu bazowana na artykule. 
Polega ona na poradzeniu sobie z rozwiązaniami niespełniającymi ograniczenia.
